...
CREATE TABLE `TAB_MESSAGES` (
  ...
  `objectId` VARCHAR(36) NULL DEFAULT NULL,
...
INSERT INTO TAB_MESSAGES (message, objectId, id_users, id_rooms) VALUES ('420YOLOSWAG', '019d522e-65b4-46f7-dccd-312bdd6a886f', (SELECT id FROM TAB_USERS WHERE username='Sam'), (SELECT id FROM TAB_ROOMS WHERE roomname='lobby'));


-- INSERT INTO TAB_USERS (username) VALUES ('Sam');
-- INSERT INTO TAB_ROOMS (roomname) VALUES ('lobby');
-- INSERT INTO TAB_MESSAGES (message, uid, id_users, id_rooms) VALUES ('hello', '1234', (SELECT id FROM TAB_USERS WHERE username = 'Sam'), (SELECT id FROM TAB_ROOMS WHERE roomname = 'main'));
